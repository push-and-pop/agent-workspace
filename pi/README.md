...
| 文件 | 说明 |
|---|---|
| `settings.json` | 主题 `volcanic-bubblegum`（来自 awesome-pi-themes）、packages 列表（rpiv-* 系列 + subagents + zentui + awesome-pi-themes + remote-pi + cc-switch fork）、默认 provider/model |
